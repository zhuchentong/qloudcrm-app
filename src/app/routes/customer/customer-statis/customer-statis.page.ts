...
export class CustomerStatisPage implements OnInit {
  ...
  public oneIndex = { index: 0, code: 'customerNum', name: '客户数统计' }
  ...
  public mergeTwo = {}
  public mergeTwo1 = {}
  public twoIndex = { index: 0, code: 'num', name: '客户数统计' }
  ...
  public mergeThree = {}
  public mergeThree1 = {}
  public threeIndex = { index: 0, code: 'num', name: '申请客户数统计' }
  ...
  public mergeFour = {}
  public mergeFour1 = {}
  public fourIndex = { index: 0, code: 'num', name: '逾期客户数统计' }
  ...
  repaintOne(config) {
    ...
    for (var index = 0; index < this.dataOne.length; index++) {
      items.push({
        name: this.dataOne[index].productTyepe,
        value: this.dataOne[index][config.code]
      })
    }
    this.mergeOne = {
  ...
  repaintTwo(config) {
    ...
    for (var index = 0; index < this.dataTwo.length; index++) {
      items.push({
        name: this.dataTwo[index].productType,
        value: this.dataTwo[index][config.code]
      })
    }
    this.mergeTwo = {
      series: [{ name: config.name, data: items }]
  ...
  repaintThree(config) {
    ...
    for (var index = 0; index < this.dataThree.length; index++) {
      items.push({
        name: this.dataThree[index].productType,
        value: this.dataThree[index][config.code]
      })
    }
    this.mergeThree = {
      series: [{ name: config.name, data: items }]
  ...
  repaintFour(config) {
    ...
    for (var index = 0; index < this.dataFour.length; index++) {
      items.push({
        name: this.dataFour[index].productType,
        value: this.dataFour[index][config.code]
      })
    }
    this.mergeFour = {
      series: [{ name: config.name, data: items }]
